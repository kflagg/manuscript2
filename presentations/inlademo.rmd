...
- `inlabru` discards the observation window
    - Cannot be used with nonconvex observation windows!
    - Unsurveyed regions are treated as surveyed with no points observed
    - Predicts very low intensity in unsurveyed regions
- Develop new wrapper code for `R-INLA` that correctly handles observation window
