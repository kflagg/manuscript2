...
\begin{figure}
\includegraphics[width=5in]{SRS000214.pdf}
\caption{Example of a simple random sample parallel line transect design.}
\label{srs000214}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{Sys000013.pdf}
\caption{Example of a systematic parallel line transect design.}
\label{sys000013}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{Inhib000171.pdf}
\caption{Example of an inhibitory plus pairs parallel line transect design.}
\label{inhib000171}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{Serp000277.pdf}
\caption{Example of a systematic serpentine transect design.}
\label{serp000277}
\end{figure}
...
\begin{figure}
\includegraphics[width=5in]{LHS-TSP000259.pdf}
