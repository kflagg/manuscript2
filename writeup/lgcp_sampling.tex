...
\begin{figure}
\includegraphics[width=5in]{lambda-SRS000187-LGCP000004.pdf}

\includegraphics[width=5in]{lambdaSD-SRS000187-LGCP000004.pdf}

\caption{Predicted log-intensity function (top) using data observed via a SRS
of line transects. The prediction standard deviation (bottom) is shown for each
finite element node.}
\label{srs000187}
\end{figure}
...
sections where the surveyed strip was observed to contain no events.
...
in oeverall SD across the study region.
...
\begin{figure}
\includegraphics[width=5in]{lambda-Serp000148-LGCP000004.pdf}

\includegraphics[width=5in]{lambdaSD-Serp000148-LGCP000004.pdf}

\caption{Predicted GP surface (top) using data observed via a serpentine transect
plan. The prediction has an apparent edge effect in the southeastern corner. The
standard deviation (bottom) is high across much of the site.}
\label{serp000148}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{MSPE-LGCP000004.png}

\includegraphics[width=5in]{MSPE-Cluster000004.png}

\caption{Plots of mean squared prediction error (MSPE) vs length of the path
for each plan applied to one realization of a LGCP (top) and one realization of
an LGCP with a cluster process overlaid (bottom). Line segments connect the
...
\begin{figure}
\includegraphics[width=5in]{APV-MSPE-LGCP000004.png}

\includegraphics[width=5in]{APV-MSPE-Cluster000004.png}

\caption{Plots of average prediction variance (APV) vs MSPE for each plan
applied to one realization of a LGCP (top) and one realization of an LGCP
with a cluster process overlaid (bottom).}
\label{apvresults}
\end{figure}
...
%\item APV median and IQR actually increase with distance for some datasets
%\begin{itemize}
...
the site could improve the prediction.


\begin{figure}
\includegraphics[width=5in]{lambda-Aug-LGCP000004.pdf}

\includegraphics[width=5in]{lambdaSD-Aug-LGCP000004.pdf}

\caption{Predicted log-intensity function (top) using data observed via a
serpentine transect design augmented post-hoc. The prediction standard
deviation (bottom) is shown for each finite element node.}
\label{aug}
\end{figure}
...
GP posterior mean of \(-8.71\) over most of the site.

\begin{figure}
\includegraphics[width=5in]{lambda-BadXsect-LGCP000004.pdf}

\includegraphics[width=5in]{lambdaSD-BadXsect-LGCP000004.pdf}

\caption{Predicted log-intensity function (top) using data observed via a
systematic sample of a small section of the site. The prediction standard
deviation (bottom) is shown for each finite element node.}
\label{badxsect}
\end{figure}
