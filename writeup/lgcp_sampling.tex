...
cluster of large, outlying MSPE values. There are no substantial differences
among the different schemes with respect to median or variability in MSPE.
...
add a subsection with example ad-hoc sequential design
...
%increasing uncertainty along path --- reasonable, path is narrow, could be
%events just out of detection range
