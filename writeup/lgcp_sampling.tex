...
objective is to map where events occur in space, various spatial mapping
...
Inhomogeneous Poisson process, log of intensity is a Gaussian process. Flexible
model for mapping intensity over space. Efficient computation tools available.
%TODO: expand and add citations.
